...
class cifar10vgg:
    def __init__(self,train=False):
        ...
        # self.adf_model = self.build_adf_model()
        # if not train:
    ...
    def train(self,model):
        ...
        model.save_weights('cifar10vgg-new.h5')
        return model
...
if __name__ == '__main__':
    ...
    loss = sum(correct)/len(correct)
    print("The model accuracy is: ",loss)