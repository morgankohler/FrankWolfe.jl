...
def store_single_result(mapping, index, fname, rate):
    ...
    np.save(f'/home/Morgan/fw-rde/mnist/results/{rate}.npy', mapping)
...
def get_distortion(x, mean=mean, covariance=covariance, model=model,
    ...
    if not os.path.exists('/home/Morgan/fw-rde/mnist/results/x.npy'):
        np.save('/home/Morgan/fw-rde/mnist/results/x.npy', x)
